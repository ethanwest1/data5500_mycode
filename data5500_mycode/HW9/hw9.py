...
#ChatGPT and I worked to debug this, but we weren't able to figure it out. We added code that allows the program to continue when this error is encountered. 
#Rather than stripping my code of the reverse logic just so the output looks nicer, I decided to include the bug rather than throwing away all of the work 
#we put into it. So I hope that you can understand where I'm coming from. 
